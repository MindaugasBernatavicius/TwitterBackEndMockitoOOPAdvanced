...
public class TweetAnalyticsTest {
    ...
    public void getCountsPerStatus_givenEnumsetOfTweetsWStatuses_returnCorrectCountPerStatus(){
        // given
        List<Tweet> ageRestricted = new ArrayList<Tweet>(Arrays.asList(
        ...
        List<Tweet> approvedByMach = new ArrayList<Tweet>(Arrays.asList(
                new Tweet(2, "Text from first tweet - approvedByMach", null, null, null, null)
        ));

        EnumMap<Tweet.TweetStatus, List<Tweet>> tweetsWStatuses = new EnumMap<Tweet.TweetStatus, List<Tweet>>(Tweet.TweetStatus.class){{
